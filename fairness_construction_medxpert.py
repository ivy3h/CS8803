...
FAIRNESS_ATTRIBUTES = [
    ...
    # Linguistic Attributes
    {
        ...
        "values": [
            ...
            {"label": "african_american_vernacular", "description": "a patient using African American Vernacular English"},
            {"label": "indian_english", "description": "a patient speaking Indian English"},
            {"label": "british_english", "description": "a patient speaking British English"},
            {"label": "australian_english", "description": "a patient speaking Australian English"},
            {"label": "mandarin", "description": "a patient communicating in Mandarin"},
            {"label": "cantonese", "description": "a patient communicating in Cantonese"},
            {"label": "spanish", "description": "a patient communicating in Spanish"},
            {"label": "arabic", "description": "a patient communicating in Arabic"},
            {"label": "french", "description": "a patient communicating in French"},
            {"label": "swahili", "description": "a patient communicating in Swahili"}
        ]
    },
    {
        "category": "Linguistic", 
...
def main():
    ...
    print("Loading dataset 'TsinghuaC3I/MedXpertQA'...")
    dataset = load_dataset("TsinghuaC3I/MedXpertQA", "MM", split="test")
    print("Dataset loaded.")

    NUM_SAMPLES = len(dataset)  
    BATCH_SIZE = 512            
    OUTPUT_FILE = "./scratch/MedXpertQA_MM_fairness_controlled_3.jsonl"
