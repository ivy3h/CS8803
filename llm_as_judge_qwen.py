...
# %%
# read each jsonl 
# subset to correct = True 
# take question, choices, answer 
# let LLM categorize error into 
# - reasoning process error 
# - question understanding error 
# - lack of medical knowledge error 
# - formatting error 
...
# also try multimodal to see if its a "Perceptual error" 
...
for entry in  prompts: # 2988 from dataset 1 
    print(entry)
    judge_all[entry] = []
    with open(entry + '_LLMAsJudge_qwen2.jsonl', "w") as f:
